 ...
 */
public class AlgoCloSpan extends SPMiningAlgorithm{
    ...
    public List<FrequentPattern> runAlgorithm(List<Sentence> input, double minsupRel){
        ...
        this.findClosedPatterns = true;
        this.executePruningMethods = true;
        
        runAlgorithm2(sequenceDatabase, keepPatterns, verbose, outputSequenceIdentifiers);
    ...
    public void runAlgorithm2(SequenceDatabase database, boolean keepPatterns, boolean verbose, boolean outputSequenceIdentifiers) {
        //calculation of the minimum relative support
        minSupAbsolute = (int) Math.ceil(minSupRelative * database.size());
        if (this.minSupAbsolute == 0) { // protection
            this.minSupAbsolute = 1;
        ...
        overallStart = System.currentTimeMillis();
        //Starting CloSpan algorithm
        cloSpan2(database, keepPatterns, verbose, findClosedPatterns, executePruningMethods, outputSequenceIdentifiers);
        //keeping the ending time
        overallEnd = System.currentTimeMillis();
        //Search for frequent patterns: Finished
        saver.finish();
    ...
    protected void cloSpan2(SequenceDatabase database, boolean keepPatterns, boolean verbose, boolean findClosedPatterns, boolean executePruningMethods, boolean outputSequenceIdentifiers) {
